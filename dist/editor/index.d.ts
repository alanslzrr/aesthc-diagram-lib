import { E as EditorStore, L as Locale, a as EditorSnapshot, S as StoreOptions } from '../layout-B5aXwz9Z.js';
...
declare function useEditorSelector<T>(select: (snapshot: ReturnType<EditorStore['getSnapshot']>) => T): T;
