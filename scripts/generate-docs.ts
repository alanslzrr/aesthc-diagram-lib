...
if (!['candidate', 'stable'].includes(release.channel) || typeof release.npmAvailable !== 'boolean')
  throw new Error('Invalid diagramRelease metadata')
if (release.channel === 'stable' && !release.npmAvailable)
  throw new Error('Stable documentation requires verified npm availability')
const availability = release.npmAvailable
